 ...
 * @package ampere
 */
$ampere_error_404 = get_theme_mod('ampere_error_404', __("404 ", 'ampere'));
$ampere_error_title = get_theme_mod('ampere_error_title', __("Sorry We Can't Find That Page! ", 'ampere'));
         ...
         <div class="col-xl-12">
            <div class="tp-error__box text-center">
               ...
               <div class="tp-error__text mb-20">
                  <p><?php print esc_html($ampere_error_text); ?></p>
               </div>
               <div class="tp-error__btn">
                  <a class="tp-btn" href="<?php print esc_url(home_url('/')); ?>"><?php print esc_html($ampere_error_link_text); ?></a>
               </div>
            </div>
         </div>
      </div>
