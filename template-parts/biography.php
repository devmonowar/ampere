...
$author_info = get_the_author_meta('ampere_write_by');
$facebook_url = get_the_author_meta('ampere_facebook');
$twitter_url = get_the_author_meta('ampere_twitter');
$linkedin_url = get_the_author_meta('ampere_linkedin');
$instagram_url = get_the_author_meta('ampere_instagram');
$ampere_url = get_the_author_meta('ampere_youtube');
$ampere_write_by = get_the_author_meta('ampere_write_by');
