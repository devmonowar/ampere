...
$ampere_menu_col = $ampere_header_right ? 'col-xxl-6 col-xl-6 col-lg-8 d-none d-lg-block' : 'col-xxl-9 col-xl-9 col-lg-8 d-none d-lg-block text-end';
$header_search_switch = get_theme_mod('header_search_switch', false);

//Phone
$header_top_phone = get_theme_mod('header_phone', __('+880190678956', 'ampere'));
$header_top_time = get_theme_mod('header_top_time', __('Sunday - Friday: 9 am - 8 pm', 'ampere'));
$header_top_menu = get_theme_mod('header_top_menu', __('top menu', 'ampere'));

// Email id 
$header_top_email = get_theme_mod('header_email', __('ampere@support.com', 'ampere'));
$ampere_sticky_logo = get_theme_mod('header_sticky_logo', get_template_directory_uri() . '/assets/img/logo/logo-white.png');
// Header Address Text
$header_top_address_text = get_theme_mod('header_address', __('734 H, Bryan Burlington, NC 27215', 'ampere'));

// Header Address Link
$header_address_link = get_theme_mod('header_address_link', __('#', 'ampere'));
                            ...
                            <div class="tp-header-top-info-3">
                                <ul>
                                    <?php if (!empty($header_top_email)) : ?>
                                        <li>
                                            <a href="mailto:<?php echo esc_html($header_top_email); ?>"><span><i class="fa-solid fa-envelope"></i></span><?php echo esc_html($header_top_email); ?></a>
                                        </li>
                                    <?php endif; ?>
                                    <?php if (!empty($header_top_address_text)) : ?>
                                        <li>
                                            <a href="<?php echo esc_url($header_address_link); ?>" target="_blank"><span><i class="fa-sharp fa-solid fa-location-dot"></i></span><?php echo esc_html($header_top_address_text); ?></a>
                                        </li>
                                    <?php endif; ?>
                                    <?php if (!empty($header_top_time)) : ?>
                                        <li>
                                            <a href=""><span><i class="fa-solid fa-clock"></i></span><?php echo esc_html__("Sunday - Friday:", "ampere") ?><b><?php echo esc_html($header_top_time); ?></b></a>
                                        </li>
                                    <?php endif; ?>
                                </ul>
                            </div>
                        ...
                        <div class="col-xxl-5 col-xl-3">
                            <div class="tp-header-top-right-3 d-flex justify-content-end align-items-center">
                                <div class="tp-header-top-social-3">
                                    <?php ampere_header_social_profiles(); ?>
                                </div>
                                <?php if (!empty($header_top_time)) : ?>
                                    <div class="tp-header-top-support d-xxl-flex d-none">
                                        <?php echo ampere_kses($header_top_menu); ?>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="col-xxl-6 col-xl-7 col-6">
                            <div class="tp-main-menu home-3 align-items-center justify-content-between d-flex">
                                <div class="tp-main-menu-logo d-block d-xl-none">
                                    <?php ampere_header_black_logo(); ?>
                                </div>
                                <div class="d-none d-xl-flex">
                                    <nav class="tp-main-menu-content">
                                        <?php ampere_onepage_menu_01(); ?>
                                    </nav>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <?php if (!empty($header_top_phone)) : ?>
                                        <div class="tp-header-contact-inner-3 d-xxl-flex align-items-center d-none">
                                            ...
                                            <div class="tp-header-contact-content">
                                                ...
                                                <span><a href="tel:<?php echo esc_attr($header_top_phone); ?>"><?php echo esc_html($header_top_phone); ?></a></span>
                                            </div>
                                        </div>
                                    <?php endif; ?>
