...
// info
$ampere_topbar_switch = get_theme_mod('header_topbar_switch', false);
...
// contact button
$ampere_button_text = get_theme_mod('ampere_button_text', __('Make Request', 'ampere'));
$ampere_button_link = get_theme_mod('ampere_button_link', __('#', 'ampere'));

// acc button
$ampere_acc_button_text = get_theme_mod('ampere_acc_button_text', __('Login', 'ampere'));
$ampere_acc_button_link = get_theme_mod('ampere_acc_button_link', __('#', 'ampere'));
...
$ampere_menu_end = $ampere_header_right ? '' : 'justify-content-end';
// header search btn 
...
<header class="tp-header-area p-relative">
    <div class="tp-header-box p-relative">
        ...
        <div class="tp-header-wrapper-inner header__sticky p-relative">
            <?php if (!empty($ampere_topbar_switch)) : ?>
        ...
        <?php if (!empty($header_top_button_switch) and !empty($header_top_button_text)) : ?>
            <div class="tp-header-btn">
                <a class="tp-btn d-none d-xl-block" href="<?php echo esc_url($header_top_button_link); ?>"><?php echo esc_html($header_top_button_text); ?><i class="fa-regular fa-arrow-right"></i></a>
