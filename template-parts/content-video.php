...
$ampere_video_url = function_exists('tpmeta_field') ? tpmeta_field('ampere_post_video') : '';
...
$social_shear_col = $ampere_singleblog_social ? "col-lg-7 col-md-7" : "col-xl-12 col-md-12 col-lg-12";
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('postbox__item tp-postbox-item-wrapper mb-80 format-image'); ?>>
        <?php if (has_post_thumbnail()) : ?>
            <div class="tp-postbox-thumb p-relative mb-25">
                ...
                <?php if (!empty($ampere_video_url)) : ?>
                    <div class="tp-postbox-thumb-btn">
                        <a class="play-btn popup-video" href="<?php echo esc_url($ampere_video_url); ?>"><i class="fa-solid fa-play"></i>
                        </a>
                    </div>
                <?php endif; ?>
            </div>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('tp-postbox-item mb-50 format-video'); ?>>
        <?php if (has_post_thumbnail()) : ?>
            <div class="tp-postbox-thumb p-relative">
                ...
                <?php if (!empty($ampere_video_url)) : ?>
                    <div class="tp-postbox-thumb-btn">
                        <a class="play-btn popup-video" href="<?php echo esc_url($ampere_video_url); ?>"><i class="fa-solid fa-play"></i></a>
                    </div>
                <?php endif; ?>
            </div>
        <?php endif; ?>
