				...
				<div class="postbox__wrapper tp-blog__wrapper mb-50">
					...
					?>
						<div class="result-bar page-header d-none">
							<h1 class="page-title"><?php esc_html_e('Search Results For:', 'ampere'); ?>
						...
						<div class="tp-pagination">
							<?php ampere_pagination('<i class="fas fa-angle-double-left"></i>', '<i class="fas fa-angle-double-right"></i>', '', ['class' => '']); ?>
						</div>
					<?php
					else :
