...
/**
 * ampere functions and definitions
 *
...
if (!function_exists('ampere_setup')) :
    ...
    function ampere_setup()
    {
        ...
        register_nav_menus([
            'main-menu' => esc_html__('Main Menu', 'ampere'),
            'onepage-menu-menu-01' => esc_html__('One Page Menu 01', 'ampere'),
        ]);
        ...
        add_theme_support('custom-background', apply_filters('ampere_custom_background_args', [
...
add_action('after_setup_theme', 'ampere_setup');
 ...
 */
function ampere_content_width()
{
    // This variable is intended to be overruled from themes.
    // Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
    // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
    $GLOBALS['content_width'] = apply_filters('ampere_content_width', 640);
}
add_action('after_setup_theme', 'ampere_content_width', 0);
 ...
 */
function ampere_pingback_header()
{
    if (is_singular() && pings_open()) {
        printf('<link rel="pingback" href="%s">', esc_url(get_bloginfo('pingback_url')));
    }
}
add_action('wp_head', 'ampere_pingback_header');

// change textarea position in comment form
// ----------------------------------------------------------------------------------------
function ampere_move_comment_textarea_to_bottom($fields)
{
...
add_filter('comment_form_fields', 'ampere_move_comment_textarea_to_bottom');


// ampere_comment 
if (!function_exists('ampere_comment')) {
    function ampere_comment($comment, $args, $depth)
    {
 ...
 *
 */
add_filter('the_content', 'ampere_shortcode_extra_content_remove');
/**
 ...
 */
function ampere_shortcode_extra_content_remove($content)
{
...
// ampere_search_filter_form
if (!function_exists('ampere_search_filter_form')) {
    function ampere_search_filter_form($form)
    {
...
add_action('admin_enqueue_scripts', 'ampere_admin_custom_scripts');


// ampere_admin_custom_scripts
function ampere_admin_custom_scripts()
{
    wp_enqueue_media();
    wp_enqueue_style('customizer-style', get_template_directory_uri() . '/inc/css/customizer-style.css', array());
    wp_enqueue_script('ampere-admin-custom', get_template_directory_uri() . '/inc/js/admin_custom.js', ['jquery'], '', true);
    wp_enqueue_script('ampere-admin-custom');
}
